...
x_task9, u_task9, t_task9, x_err_task9, mode_task9 = nanosat.rk4(400, 1, nanosat.nadir_pointing_torque)
sigma_sun_err_hist = x_err_task9[:,:3]
omega_sun_err_hist = x_err_task9[:,3:]
...
plt.subplot(2,2,1)
plt.plot(t_task9, sigma_sun_err_hist[:,0], label=r'$\sigma_1$')
plt.plot(t_task9, sigma_sun_err_hist[:,1], label=r'$\sigma_2$')
plt.plot(t_task9, sigma_sun_err_hist[:,2], label=r'$\sigma_3$')
finalize_plot(r'Attitude Errors')

plt.subplot(2,2,2)
plt.plot(t_task9, omega_sun_err_hist[:,0], label=r'$\omega_1$')
plt.plot(t_task9, omega_sun_err_hist[:,1], label=r'$\omega_2$')
plt.plot(t_task9, omega_sun_err_hist[:,2], label=r'$\omega_3$')
finalize_plot(r'Angular Velocity Errors [$rad/s$]')

plt.subplot(2,2,3)
plt.plot(t_task9, sigma_sun_err_hist_norm, label=r'$|\sigma|$')
...
plt.subplot(2,2,4)
plt.plot(t_task9, omega_sun_err_hist_norm, label=r'$|\omega|$')
