...
x_task10, u_task10, t_task10, x_err_task10, mode_task10 = nanosat.rk4(400, 1, nanosat.comms_pointing_torque, gmo)
sigma_sun_err_hist = x_err_task10[:,:3]
omega_sun_err_hist = x_err_task10[:,3:]
...
plt.subplot(2,2,1)
plt.plot(t_task10, sigma_sun_err_hist[:,0], label=r'$\sigma_1$')
plt.plot(t_task10, sigma_sun_err_hist[:,1], label=r'$\sigma_2$')
plt.plot(t_task10, sigma_sun_err_hist[:,2], label=r'$\sigma_3$')
finalize_plot(r'Attitude Errors')

plt.subplot(2,2,2)
plt.plot(t_task10, omega_sun_err_hist[:,0], label=r'$\omega_1$')
plt.plot(t_task10, omega_sun_err_hist[:,1], label=r'$\omega_2$')
plt.plot(t_task10, omega_sun_err_hist[:,2], label=r'$\omega_3$')
finalize_plot(r'Angular Velocity Errors [$rad/s$]')

plt.subplot(2,2,3)
plt.plot(t_task10, sigma_sun_err_hist_norm, label=r'$|\sigma|$')
...
plt.subplot(2,2,4)
plt.plot(t_task10, omega_sun_err_hist_norm, label=r'$|\omega|$')
